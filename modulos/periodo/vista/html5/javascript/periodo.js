...
function montarListar(periodos){
	if(periodos != null){
		...
		for(var i = 0; i < periodos.length; i++){
			...
			cadena += "<td>";
			cadena += " <button class='btn btn-primary' title='Modificar Periodo' onclick='obtener(\""+periodos[i]['codigo']+"\")'><i class='icon-pencil'></i></button>";
			cadena += " <button class='btn btn-danger' title='Reporte de Periodo' onclick='window.location.assign(\"index.php?m_modulo=periodo&m_accion=obtenerIP&m_formato=pdf&m_vista=reportePeriodo&periodos="+periodos[i]['codigo']+"\")'><i class='icon-book'></i></button>"
			
			cadena += " <button class='btn btn-danger' title='Lista de estudiantes EN CONSTRUCCION (johan alamo)' onclick='window.location.assign(\"index.php?m_modulo=periodo&m_accion=obtenerIP&m_formato=pdf&m_vista=reportePeriodo&periodos="+periodos[i]['codigo']+"\")'><i class='icon-book'></i></button>"
			cadena += " <button class='btn btn-danger' title='Notas EN CONSTRUCCION (johan alamo)' onclick='window.location.assign(\"index.php?m_modulo=periodo&m_accion=obtenerIP&m_formato=pdf&m_vista=reportePeriodo&periodos="+periodos[i]['codigo']+"\")'><i class='icon-book'></i></button>"
